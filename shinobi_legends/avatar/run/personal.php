<?php
		...
		output("\"`\$Please note that you need to have proper rights to the image - by giving the link you acknowledge you have the right to use it here on the site!.`7\"`n`n");
