	...
	case "buffdragon":
		...
		if($breathfire && e_rand(1, 100) < get_module_setting("firechance")){
			...
			apply_buff('dragonfire', array(
				"startmsg"=>"`n`^The Orochimaru attacks with his snake arms!`n`n",
				"name"=>"`%Snake Arms",
				"rounds"=>30,
				"wearoff"=>"The Orochimaru's snakes appears to be slain. He must be getting weak now.",
				"minioncount"=>1,
				"mingoodguydamage"=>0,
				"maxgoodguydamage"=>$maxfiredamage,
				"effectmsg"=>"`7You are engulfed in `4Orochimaru's snakes`7 and take`4 {damage} `7damage.`0",
				"effectnodmgmsg"=>"`7You are engulfed in `4Orochimaru's snakes`7 but take no damage.`0",
