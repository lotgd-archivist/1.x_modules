...
function serversuspend_getmoduleinfo(){
	$info = array(
		...
		"settings"=> array (
			"Server Suspend,title",
			"text"=>"What text do you want to show to explain why the server is suspended and how long it will take? The standard text is displayed before that one,text|",
			),
	);
	return $info;
}
