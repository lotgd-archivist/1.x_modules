...
function holiday_pirate_munge($in) {
	...
	$out = str_replace("Orochimaru","T' Nasty ol' Snake",$out);	
	$out = str_replace("Kyuubi","T' Lil' D'mon Fella",$out);	
	$out = str_replace("Shizuni","Rusty ol' Maid",$out);	
	$out = str_replace("Baluski","Balu t' Bear",$out);	
	$out = str_replace("Neji","t' Jyuuken Fella",$out);	
	$out = str_replace("woman","nice sturdy lass",$out);	
	$out = str_replace("I like ","I can't get my hands off ",$out);	
	$out = str_replace("Kabuto","t' fo'-eyed landrat",$out);	
	$out = str_replace("Country","Sealand",$out);	
	$out = str_replace("Forest","Sea of Horrors",$out);		
	$out = str_replace("forest","sea",$out);	
	$out = str_replace("Bank","Sea Treasury",$out);
	$out = str_replace("Staff","Seadog",$out);	
	$out = str_replace("","",$out);		
	$out = str_replace("Weapon","Paddle",$out);	
	$out = str_replace("Armor","Pirate Outfit",$out);
	$out = str_replace("weapon","paddle",$out);	
	$out = str_replace("armor","pirate outfit",$out);		
	$out = str_replace("defeated","paddled",$out);
	$out = str_replace("lost","was paddled",$out);	
	$out = str_replace("You","Ye",$out);
