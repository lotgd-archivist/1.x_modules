...
function loveshack_lovedrinks() {
	...
	if (is_module_installed('drinks')&&$s<$z) {
		...
		if ($s<1) { // We use 'lessthan' so more drinks can be packaged with this
			$sql[]="INSERT INTO " . db_prefix("drinks") . " VALUES (0, 'Love Brew', 1, 25, 5, 0, 0, 0, 20, 0, 5, 15, 0.0, 0, 0, 'The keep reaches under the bar, pulling out a purple cupid shaped bottle... as he pours it into a crystalline glass, the glass shines and he puts a pineapple within the liquid... \"Here, have a Love Brew..\" says the keep.. and as you try it, you feel uplifted!', '`%Love Brew', 12, 'You remember love..', 'Despair sets in.', '1.1', '.9', '1.5', '0', '', '', '')";
			$ladd[]="Love Brew";
		}
...
function loveshack_lovedrinksrem() {
