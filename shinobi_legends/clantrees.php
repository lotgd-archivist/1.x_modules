...
function clantrees_run(){
	...
	if ($op=="buytree") {
		...
		$salesman=get_module_setting("salesman");
		if ($size=="small") {
			output("`@%s`@ nods at your request, and motions to his assistant `\$Kakuzu`@(who glares at him dangerously) to take the little thing into your clan hall.",$salesman);
			...
			output("`@%s`@ nods at your request, and motions to his assistant `\$Kakuzu`@ to take the tree into your clan hall.",$salesman);
			...
			output("While you are wondering how to get the tree into the hall, a Sensei wanders by, lecturing his apprentices on the basics of levitation as they scurry after him.");
			output("`\$Kakuzu`@ quickly takes advantage of this, and within minutes the shinobi are all helping move the tree into your hall for levitation practice.");
