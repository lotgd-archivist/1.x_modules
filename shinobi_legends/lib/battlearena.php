<?php
	...
	$op = httpget('op');
	$gladiators=array();
	array_push($gladiators,array("name"=>"`2Konohamaru","level"=>9,"battlepoints"=>-500,"dks"=>0,"weapon"=>translate_inline("Nasty Tricks")));
	array_push($gladiators,array("name"=>"`@Chouji","level"=>10,"battlepoints"=>12,"dks"=>1,"weapon"=>translate_inline("Meatball Attack")));
	array_push($gladiators,array("name"=>"`^Ino","level"=>11,"battlepoints"=>36,"dks"=>2,"weapon"=>translate_inline("Shinrantenshin")));
	array_push($gladiators,array("name"=>"`@Rock Lee","level"=>12,"battlepoints"=>72,"dks"=>3,"weapon"=>translate_inline("impressive Taijutsu")));
	array_push($gladiators,array("name"=>"`3Hyuuga Hinata","level"=>13,"battlepoints"=>120,"dks"=>4,"weapon"=>translate_inline("Shugohakke Rokkujyuuyonshou")));
	array_push($gladiators,array("name"=>"`@Hyuuga Neji","level"=>14,"battlepoints"=>180,"dks"=>5,"weapon"=>translate_inline("Hakkeshou Kaiten")));
	array_push($gladiators,array("name"=>"`\$Uchiha Sasuke","level"=>15,"battlepoints"=>336,"dks"=>7,"weapon"=>translate_inline("Mangekyou Sharingan")));
	array_push($gladiators,array("name"=>"`4Uzumaki Naruto","level"=>15,"battlepoints"=>1000,"dks"=>9,"weapon"=>translate_inline("Rasengan")));
	array_push($gladiators,array("name"=>"`2Kakashi","level"=>16,"battlepoints"=>1600,"dks"=>12,"weapon"=>translate_inline("Suiton Suiryuudan")));
	array_push($gladiators,array("name"=>"`@Orochimaru Bunshin","level"=>17,"battlepoints"=>2000,"dks"=>16,"weapon"=>translate_inline("Forbidden Jutsu")));
	array_push($gladiators,array("name"=>"`!Shodaime Hokage Bunshin","level"=>18,"battlepoints"=>2500,"dks"=>20,"weapon"=>translate_inline("Mokuton Hijutsu Jukai Koutan")));
	array_push($gladiators,array("name"=>"`2Nidaime Hokage Bunshin","level"=>19,"battlepoints"=>3000,"dks"=>25,"weapon"=>translate_inline("Suiton Suijinheki")));
	array_push($gladiators,array("name"=>"`QSandaime Hokage Bunshin","level"=>20,"battlepoints"=>4000,"dks"=>30,"weapon"=>translate_inline("Katon Karyuu Endan")));
	array_push($gladiators,array("name"=>"`qYondaime Hokage Bunshin","level"=>21,"battlepoints"=>4000,"dks"=>45,"weapon"=>translate_inline("Shin Rasengan")));
	...
	case "win":
		...
		addnews("`2%s`2 has beaten %s`2 in the Battle Arena!",$session['user']['name'],$gladiators[$number]['name']);
	...
	case "loose":
		...
		addnews("`2%s`2 has lost to %s`2 at the Battle Arena.",$session['user']['name'],$gladiators[$number]['name']);
		output("`#The Arena healers heal your wounds.`n");
		set_module_pref("ubattlepoints",$ubattlepoints);
		$session['user']['hitpoints']=$session['user']['maxhitpoints'];
		battlearena_isnewleader();
		addnav("Continue","runmodule.php?module=battlearena");
		break;
	case "prepare":
		...
		$badguy = array("creaturename"=>$gladiators[$number]['name']."`0"
						,"creaturelevel"=>$gladiators[$number]['level']//$gladiators[$number]['level']
      					,"creatureweapon"=>$gladiators[$number]['weapon']
      					,"creatureattack"=>1+$number+($number*5)//70+($number*5)
      					,"creaturedefense"=>1+$number+($number*5)//70+($number*5)
		...
		if ($number>6) {
			...
			$badguy['creatureattack']+=e_rand(0,10);
			$badguy['creaturedefense']+=e_rand(0,10);
			if ($number>7) {
