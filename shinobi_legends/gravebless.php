...
function gravebless_dohook($hookname, $args) {
	...
	case "newday":
		...
		if ($blessed) {
			...
			if ($ramiusarmor) {
				$ramiusbuff = array("name"=>array("`%s`\$'s Blessed Armor",$deathoverlord),
									"rounds"=>-1,
									"defmod"=>1.25,
				...
				$ramiusbuff = array("name"=>array("%s`\$'s Blessed Weapon",$deathoverlord),
									"rounds"=>-1,
									"atkmod"=>1.25,
									"lifetap"=>$multiplier,
			...
			if ($ramiusarmor) {
				$ramiusbuff = array("name"=>array("%s`4's Cursed Armor",$deathoverlord),
									"rounds"=>-1,
									"defmod"=>0.8,
									"badguyatkmod"=>1.25,
				...
				$ramiusbuff = array("name"=>array("%s`4's Cursed Weapon",$deathoverlord),
									"rounds"=>-1,
									"atkmod"=>0.8,
									"badguydefmod"=>1.25,
