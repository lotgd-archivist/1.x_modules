...
if ($op2=="wreiten2"){
		    ...
		    $title = "";
			if ($fest==1) output("`c`^`bErgebnisse: Die %s Reiter bei diesem Wettbewerb`b`c", $adverb);
		    if ($fest==0) output("`c`^`bErgebnisse: Die %s Reiter beim letzten Wettbewerb`b`c", $adverb);
		    $tags = array("Punkte");
