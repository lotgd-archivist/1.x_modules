<?php
		if ($op2=="wbogen2"){
		    ...
		    if ($fest==1) output("`c`^`bErgebnisse: Die %s Schnellschützen dieses Wettbewerbs`b`c", $adverb);
		    if ($fest==0) output("`c`^`bErgebnisse: Die %s Schnellschützen des letzten Wettbewerbs`b`c", $adverb);
		    $tags = array("Punkte");
