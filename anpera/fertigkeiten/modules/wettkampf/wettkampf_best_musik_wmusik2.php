<?php
	if ($op2=="wmusik2"){
	    ...
	    $title = "";
		if ($fest==1) output("`c`^`bErgebnisse: Die %s Interpreten bei diesem Wettbewerb`b`c", $adverb);
	    if ($fest==0) output("`c`^`bErgebnisse: Die %s Interpreten beim letzten Wettbewerb`b`c", $adverb);
	    $tags = array("Punkte");
