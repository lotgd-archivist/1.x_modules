<?php
		...
		if ($op2=="wschwimm2"){
		    ...
		    $title = "";
			if ($fest==1) output("`c`^`bErgebnisse: Die %s Schwimmer und Taucher im Schlammtümpel bei diesem Wettbewerb`b`c", $adverb);
		    if ($fest==0) output("`c`^`bErgebnisse: Die %s Schwimmer und Taucher im Schlammtümpel beim letzten Wettbewerb`b`c", $adverb);
		    $tags = array("Punkte");
