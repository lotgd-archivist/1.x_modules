<?php
		if ($op2=="wbogen3"){
		    ...
		    $title = "";
			if ($fest==1) output("`c`^`bErgebnisse: Die %s Schützen dieses Wettbewerbs`b`c", $adverb);
		    if ($fest==0) output("`c`^`bErgebnisse: Die %s Schützen des letzten Wettbewerbs`b`c", $adverb);
		    $tags = array("Punkte");
