<?php
		if ($op2=="wbogen1"){
		    ...
		    $title="";
			if ($fest==1) output("`c`^`bErgebnisse: Die %s Blindschützen dieses Wettbewerbs`b`c", $adverb);
		    if ($fest==0) output("`c`^`bErgebnisse: Die %s Blindschützen des letzten Wettbewerbs`b`c", $adverb);
		    $tags = array("Punkte");
