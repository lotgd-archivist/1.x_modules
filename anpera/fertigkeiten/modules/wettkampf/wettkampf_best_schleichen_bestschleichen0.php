...
if ($op2=="bestschleichen0"){
		    ...
		    if ($subop == "least") $adverb = translate_inline("ungeschicktesten");
		    $title = output("`c`^`bDie %s Schleicher aller Zeiten:`b`c", $adverb);
		    $tags = array("Minuten");
