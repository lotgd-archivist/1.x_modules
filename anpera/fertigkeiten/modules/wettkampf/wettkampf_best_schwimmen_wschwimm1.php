<?php
		if ($op2=="wschwimm1"){
		    ...
		    $title = "";
			if ($fest==1) output("`c`^`bErgebnisse: Die %s Langzeittaucher im Schlammtümpel bei diesem Wettbewerb`b`c", $adverb);
		    if ($fest==0) output("`c`^`bErgebnisse: Die %s Langzeittaucher im Schlammtümpel beim letzten Wettbewerb`b`c", $adverb);
		    $tags = array("Minuten");
