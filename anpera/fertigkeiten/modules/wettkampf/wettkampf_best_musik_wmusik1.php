<?php
	if ($op2=="wmusik1"){
	    ...
	    $title = "";
		if ($fest==1) output("`c`^`bErgebnisse: Die %s Stimmungsmacher bei diesem Wettbewerb`b`c", $adverb);
	    if ($fest==0) output("`c`^`bErgebnisse: Die %s Stimmungsmacher beim letzten Wettbewerb`b`c", $adverb);
	    $tags = array("Punkte");
